...
// Image scroll effect
const boxImages = document.querySelectorAll(".box1");
...
//image scroll effect
const zoom1Images = document.querySelectorAll(".image-zoom1");
...
//TEXT scroll effect
const textbox1 = document.querySelectorAll(".text-box1");
const textbox2 = document.querySelectorAll(".text-box2");
